          ...
          <div className="container">
            <div className="hero__panel">
              ...
              <p className="hero__lead">
                Acompañamos a las áreas de TI que necesitan orden, cobertura y aliados
                comprometidos con la continuidad de su operación.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="seguridad" className="section section--alternate" aria-labelledby="seguridad-title">
          <div className="container">
            <div className="section__content">
              ...
              <li>
                <strong>Migración de políticas:</strong> Transferimos las políticas de tu solución actual a ESET con un proceso de
                homologación según las capacidades de la suite de ESET contratada.
              </li>
              <li>
