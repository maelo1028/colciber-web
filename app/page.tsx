...
const summaryParagraphs = [
  ...
  "Tratabajamos con ESET desde hace mas de 10 años (somos ex empleados de ESET Colombia) no trabajamos con otras marcas somos ESET lovers. Si no conoces a ESET visita nuestra pagina (colciber.co/eset) para que entiendas por qué. Ademas complementamos nuestra propuesta de seguridad de la información con Isl Online que es un soporte remoto seguro (mejor que teamviewer). Distribuimos InvGate que es una marca que ofrece software de mesa de ayuda y control de inventarios de tecnologia (Es mucho mas que esto pero es resumen). Y finalmente distribuimos un software de prevención de fuga de la información (DLP) para las empresas que quieren prevenir que su información se fugue por "accidente".",
  "Nuestra propuesta no es vender licencias: Tienes soporte ilimitado sin peros, simulacros de phishing que te regalamos para que tu gente despierte (y si quieres algo más pro, también te lo montamos) y, por si fuera poco, te dejamos todo listo para usar y te ayudamos a administrarlo en coadministración; esa es, en serio, la diferencia. Si algo de esto te suena a lo que tu empresa necesita, déjanos tus datos, armamos una prueba sin compromiso y, si al final no te sirve (cosa que dudamos bastante), no pasa nada: pero ya sabes quién te habla sin maquillaje cuando de TI se trata.",
];
